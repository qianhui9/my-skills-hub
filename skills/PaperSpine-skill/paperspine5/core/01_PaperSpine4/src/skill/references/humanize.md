...
Humanization must not turn supported scientific statements into timid prose.
Read `references/assertive-scientific-writing.md`: vary rhythm and remove AI
patterns while retaining direct results, a clear contribution, and only the
hedges that change scientific interpretation.
